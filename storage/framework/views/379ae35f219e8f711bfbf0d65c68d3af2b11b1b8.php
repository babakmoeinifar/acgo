                                ...
                                <div class="card-header-action">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-list dropdown-menu-right Filter-dropdown w-64">
                                            <?php echo e(Form::open(array('route' => array('vender.transaction'),'method' => 'GET'))); ?>
                                            ...
                                            <div class="text-right">
                                                ...
                                                <a href="<?php echo e(route('vender.transaction')); ?>" class="btn btn-danger"><?php echo e(__('Reset')); ?></a>
                                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/accgo/resources/views/vender/transaction.blade.php ENDPATH**/ ?>