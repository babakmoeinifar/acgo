...
if (isset($messageCache)) { $message = $messageCache; }
                                            ...
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('stripe_currency_symbol',__('Currency Symbol *'))); ?>

                                                <?php echo e(Form::text('stripe_currency_symbol',isset($settings['stripe_currency_symbol'])?$settings['stripe_currency_symbol']:'',array('class'=>'form-control'))); ?>

                                                <?php if ($errors->has('stripe_currency_symbol')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('stripe_currency_symbol'); ?>
...
if (isset($messageCache)) { $message = $messageCache; }
                                            ...
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('stripe_currency',__('Currency *'))); ?>

                                                <?php echo e(Form::text('stripe_currency',isset($settings['stripe_currency'])?$settings['stripe_currency']:'',array('class'=>'form-control font-style'))); ?>

                                                <small><a href="https://stripe.com/docs/currencies" target="_blank"><?php echo e(__('Refer this site for stripe supported currencies')); ?></a></small> <br><p class="text-danger"><?php echo e(__('Please use same name of currency as per stripe document otherwise you will have issue on stripe checkout.')); ?></p><br>
                                                <?php if ($errors->has('stripe_currency')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('stripe_currency'); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/accgo/resources/views/settings/index.blade.php ENDPATH**/ ?>