    ...
    <div class="col-lg-4 col-md-4 col-sm-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <?php echo e(Form::text('billing_zip',null,array('class'=>'form-control','placeholder'=>__('Enter User Email'),'required'=>'required'))); ?>
    ...
    <div class="col-lg-4 col-md-4 col-sm-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <?php echo e(Form::text('shipping_zip',null,array('class'=>'form-control','placeholder'=>__('Enter User Email'),'required'=>'required'))); ?>
...
<?php /**PATH /var/www/accgo/resources/views/vender/create.blade.php ENDPATH**/ ?>