    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="<?php echo e(route('vender.dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></div>
                                ...
                                <div class="card-header-action">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-list dropdown-menu-right Filter-dropdown w-64">
                                            <?php echo e(Form::open(array('route' => array('vender.payment'),'method' => 'GET'))); ?>
                                            ...
                                            <div class="text-right">
                                                ...
                                                <a href="<?php echo e(route('vender.payment')); ?>" class="btn btn-danger"><?php echo e(__('Reset')); ?></a>
                                            </div>
                                                ...
                                                <table class="table table-flush font-style" id="dataTable">
                                                    ...
                                                    <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo e(!empty($payment->billPayment)? !empty($payment->billPayment->paymentMethod)?$payment->billPayment->paymentMethod->name:'' :''); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/accgo/resources/views/vender/payment.blade.php ENDPATH**/ ?>