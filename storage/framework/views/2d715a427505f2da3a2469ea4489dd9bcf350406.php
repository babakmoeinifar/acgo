                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        ...
                                        <table data-v-f2a183a6="" class="summary-table">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e(\App\Utility::dateFormat($settings,$proposal->due_date)); ?></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            ...
                                            <div class="d-table-body">
                                                <?php if(isset($proposal->items) && count($proposal->items) > 0): ?>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::priceFormat($settings,$proposal->getSubTotal())); ?></div>
                                                    </div>
                                                    <?php if($proposal->discount_apply==1): ?>
                                                        ...
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                    <?php if($proposal->getTotalTax()): ?>
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Tax')); ?> </div>
                                                            <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::priceFormat($settings,$proposal->getTotalTax())); ?></div>
                                                        </div>
                                                    <?php endif; ?>
...
<?php /**PATH /var/www/accgo/resources/views/proposal/templates/template1.blade.php ENDPATH**/ ?>