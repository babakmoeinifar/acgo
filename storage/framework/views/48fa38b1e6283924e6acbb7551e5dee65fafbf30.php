                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        ...
                                        <table data-v-f2a183a6="" class="summary-table">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e(\App\Utility::dateFormat($settings,$bill->issue_date)); ?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    ...
                                                    <?php if($bill->discount_apply==1): ?>
                                                        ...
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                    <?php if($bill->getTotalTax()): ?>
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Tax')); ?> </div>
                                                            <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::priceFormat($settings,$bill->getTotalTax())); ?></div>
                                                        </div>
                                                    <?php endif; ?>
...
<?php /**PATH /var/www/accgo/resources/views/bill/templates/template1.blade.php ENDPATH**/ ?>