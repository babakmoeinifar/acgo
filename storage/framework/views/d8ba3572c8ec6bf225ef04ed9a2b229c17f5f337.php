                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between w-100">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create user')): ?>
                                <a href="#" data-url="<?php echo e(route('users.create')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Create New User')); ?>" class="btn btn-icon icon-left btn-primary">
                                        ...
                                        <div class="staff staff-grid-view pb-0">
                                            ...
                                            <div class="meta-info mb-3">
                                                ...
                                                <?php if($user->delete_status==0): ?>
                                                    <p class="soft-del"><?php echo e(__('Soft Deleted')); ?></p>
                                                <?php endif; ?>
                                            </div>
                                            <?php if(\Auth::user()->type == 'super admin'): ?>
                                                ...
                                                <div class="btn-wrap">
                                                    <button class="btn" title="Total Users">
                                                        ...
                                                        <span class="pl-2"><?php echo e($user->totalCompanyUser($user->id)); ?></span>
                                                    </button>
                                                    <button class="btn" title="Total Customers">
                                                        <i class="fas fa-users"></i>
                                                        <span class="pl-2"><?php echo e($user->totalCompanyCustomer($user->id)); ?></span>
                                                    </button>
                                                    <button class="btn" title="Total Vendors">
                                                        <i class="fas fa-users"></i>
                                                        <span class="pl-2"><?php echo e($user->totalCompanyVender($user->id)); ?></span>
                                                    </button>
                                                </div>
                                            <?php endif; ?>
                                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/accgo/resources/views/user/index.blade.php ENDPATH**/ ?>