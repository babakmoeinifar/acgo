            ...
            <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                    ...
                    <div class="card card-primary">
                        <div class="card-header"><h4><?php echo e(__('Customer Login')); ?></h4></div>
                        <div class="col-12 text-right">
                            <a href="<?php echo e(route('login')); ?>" class="btn btn-secondary"><?php echo e(__('User Login')); ?></a>
                        </div>
                        <div class="card-body">
                            <?php echo e(Form::open(array('route'=>'customer.login','method'=>'post','id'=>'loginForm','class'=> 'login-form' ))); ?>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/accgo/resources/views/auth/customer_login.blade.php ENDPATH**/ ?>